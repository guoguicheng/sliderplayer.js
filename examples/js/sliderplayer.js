...
sliderplayer.prototype.sliderplay=function(autoplay){
	this.context.fillRect(0,0, this.w, this.h);
	this._draw(this.context, this.imageList[this.id], this.animateList);
}
sliderplayer.prototype.slideautoplay=function() {
	this._loop();
}
